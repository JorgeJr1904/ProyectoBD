		...
		<form action="validacionPago.jsp" id="formulario-tarjeta" class="formulario-tarjeta">
			...
			<div class="grupo">
				<label for="inputNombre">Nombre</label>
                                <input type="text" id="inputNombre" maxlength="19" autocomplete="off" name="nombreTarjeta">
			</div>
			<div class="flexbox">
				...
				<div class="grupo ccv">
					...
					<input type="text" id="inputCCV" maxlength="3">
                        ...
                        <div class="grupo">
				<label for="inputNumero">Nombre a Facturar</label>
				<input type="text" name="nombreFactura">
                        </div>
                        <div class="grupo">
				<label for="inputNumero">Direccion</label>
				<input type="text" name="direccionFactura">
                        </div>
                        <div class="grupo">
				<label for="inputNumero">Telefono</label>
				<input type="text" name="telefonoFactura">
			</div>
                    <input hidden="" type="text" name="usuario" value="<%=usuario%>">
                    <input hidden="" type="text" name="rol" value="<%=rol%>">
                        <input hidden="" type="text" name="idReservacion" value="<%=idReservacion%>">
                        <input hidden="" type="text" name="tipoPago" value="<%=tipoPago%>">
			<button type="submit" class="btn-enviar" name="btn_pago" value="datosPagoNoAutomatico">Enviar</button>
		</form>
	</div>
